		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<a class="btn btn-sm btn-primary mb-4"
					href="/admin/language-and-technology/create"><i
					class="fas fa-plus mr-2"></i>Add new</a>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<form action="/admin/language-and-technology" method="get"
					...
					<table class="table table-striped text-center">
						<thead>
							<tr>
								...
								<th scope="col"><a
									href="?page=${resultList.currentPage}&${pagingParam}"
