...
<div id="content">
	...
	<div class="container-fluid">
		...
		<c:if test="${action eq 'create'}">
			<c:set var="formAction" value="/admin/language-and-technology/create"></c:set>
		</c:if>
		<c:if test="${action eq 'edit'}">
			<c:set var="formAction" value="/admin/language-and-technology/edit"></c:set>
		...
		<div class="card o-hidden border-0 shadow-lg mb-5 mt-3">
			<div class="card-body p-0">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="p-5">
							<f:form cssClass="user" modelAttribute="ltDTO" method="post"
								action="${formAction}">
										...
										<div class="col-12 col-sm-12 ${col} mb-3">
											...
											<f:select path="status" cssClass="form-control"
												style="font-size: .8rem;
												    ...
												    padding: 0.9rem 1rem;
												    height:auto;">
												<option value="0" ${ltDTO.status == 0 ? "selected" : ""}>Inactive</option>
												<option value="1" ${ltDTO.status == 1 ? "selected" : ""}>Active</option>
											</f:select>
										</div>
									</c:if>
								</div>
								<div class="form-group row">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-3">
										<a href="/admin/language-and-technology"
