	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<a class="btn btn-sm btn-primary mb-4" href="/admin/title/create"><i
					class="fas fa-plus mr-2"></i>Add new</a> <a
					class="btn btn-sm btn-primary mb-4"
					href="/admin/title/change-index-position"><i
					class="fas fa-retweet mr-2"></i>Change the index position</a>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<form action="/admin/title" method="get"
					...
					<table class="table table-striped text-center">
						<thead>
							<tr>
								...
								<th scope="col"><a
									href="?page=${resultList.currentPage}&orderBy=titleIndex${pagingParam}"
